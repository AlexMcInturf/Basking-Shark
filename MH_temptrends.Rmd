...
ggplot(data = mhdat, aes(x = month, y = meant, color = year)) +       
  geom_line(aes(group = year)) 

# And sun over time 
ggplot(data = mhdat, aes(x = month, y = sun, color = year)) +       
  geom_line(aes(group = year)) 
...
```{r}
library(ggplot2)
mhsight <- mhdat[(mhdat$month==5|mhdat$month==6|mhdat$month==7|mhdat$month==8|mhdat$month==9),]
...
ggplot(data = mhsight, aes(x = factor(year), y = meant, color = month)) +       
...
# curious to zoom in and see the data from the past 10 years for July and August
mhsightrec <- mhsight2[(mhsight2$year==2010|mhsight2$year==2011|mhsight2$year==2012|mhsight2$year==2013|mhsight2$year==2014|mhsight2$year==2015|mhsight2$year==2016|mhsight2$year==2017),]
head(mhsightrec)

ggplot(data = mhsightrec, aes(x = year, y = meant, color = factor(month))) +       
  geom_line(aes(group = factor(month))) + geom_point()
