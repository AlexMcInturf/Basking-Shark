...
head(acc_sub)
 #applying the time points to the data, we want all of the rows that correspond to the timeseq (or the extracted points)
head(acc_sub)
summary(acc_sub)
nrow(acc_sub)
...
```
Using practice "Signal" to do some signal processing on accelerometer